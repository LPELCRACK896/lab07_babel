...
const myBookChapters = {
  ...
  d: {
    ...
    progreso: "67%",
    anterior: "root",
    parrafos: ["¿Qué más da si se toma un día más en casa? Después de todo han sido días duros para él.", "Mi camino esta mañana sería un tanto diferente al habitual; dado que no puedo dejar a Han solo en casa hasta que vuelva, debo pasar por casa de mi tía Manne a pedirle que venga a verlo en la mañana. Mi pequeño desvío me haría demorar aún más llegar a la escuela así que debía salir lo más pronto posible. Tomé rápidamente mi mochila, empacando en ella una manzana y un cuaderno de líneas, tomé el abrigo y llaves que estaban sobre el recibidor y me retiré de casa cerrando la puerta con la mayor delicadeza posible para no despertar a mi hermano.", "La propiedad que había dejado Mark a mi tía era muy grande y bastante lujosa, pero era también la cabaña más alejada de la ciudad. Para ser específicos, quedaba al norte del centro del pueblo, sobre una colina lo suficientemente alta para ver el pueblo siempre y que la neblina lo permitiese. Mi casa, por otro lado, quedaba en el barrio sur, así que podrán imaginar el largo recorrido hasta su casa.", "Saliendo del centro, noté como la niebla se hacía poco a poco más densa y el clima iba cambiando según salían unos tímidos rayos del sol. El panorama poco a poco se fue transformando en un bosque denso lleno de pinos pintados con nieve y algunos ciervos temerosos que se alejan según notan mi presencia. He de confesar que disfruto de lugares como estos, la sensación de paz que genera estar rodeado únicamente de árboles es algo que me cuesta describir, aunque finalmente lo homogéneo del lugar también lo convierte en un lugar confuso por el cual moverse.", "—CLACK— sin previo aviso, cae detrás de mía una rama lo suficientemente pesada para dejarme inconsciente, rozando mi abrigo y erizándome la piel. Inmediatamente después, me giro para verificar lo sucedido con la rama. Un cadáver.", "Caí de espaldas sobre la nieve y contemplé unos instantes más el cadáver frente a mí: tenía un rostro pálido y helado por el clima, aún tenía puesto delgado abrigo verde; jamás le había visto. Me levanté deprisa y corrí en la primera dirección frente a mí. No estaba tan cerca del pueblo para llegar a la comisaría, pero seguro que la cabaña de mi tía Manne estaba muy cerca. De repente, la niebla se densifico aún más, para finalmente dejarme sin visión y completamente perdido en el bosque. Dejé de correr después de darme cuenta que no iba a ningún lado, y únicamente permanecí caminando en una misma dirección; Lo que una vez me pareció un lugar hermoso donde encontraba paz, me pareció un manicomio sin entrada ni salida.", "Justo cuando iba a darme por vencido y sentarme a descansar, alcancé a ver a lo lejos la luz borrosa de un farol que señala la presencia de una cabaña que nunca antes había visto. El hogar solitario no tenía ninguna otra señal de vida dentro, pero en la zona parecía el único lugar en el cual pedir ayuda."],
    opciones: [{
  ...
  ii: {
    ...
    progreso: "100%",
    anterior: "i",
    parrafos: ["Final conseguido: Secretos bajo la cama I", "Puntuación 4/5"]
  },
  id: {
    numero_de_cap: "3",
    ...
    progreso: "100%",
    anterior: "i",
    parrafos: ["Final conseguido: Primera plana II", "Puntuación 2/5"]
  },
  di: {
    numero_de_cap: "3",
    titulo: "Demonio Azul",
    progreso: "100%",
    anterior: "d",
    parrafos: ["Final conseguido: Demonio Azul III", "Puntuación 5/5"]
  },
  dd: {
    numero_de_cap: "3",
    ...
    progreso: "100%",
    anterior: "d",
    parrafos: ["Final conseguido: Entierro nevado IV", "Puntuación 3/5"]
  }
};
